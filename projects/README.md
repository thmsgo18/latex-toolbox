Ce dossier peut servir a stocker des projets reels si tu veux les garder dans la toolbox.

La commande `latex-toolbox` ne cree plus automatiquement ici : elle cree un projet dans le dossier courant.
